...
def write_landing_telemetry(
    ...
    try:
        ...
        payload = {
            ...
            "rvec": det.get("rvec"),
            "target_center_camera_m": det.get("target_center_camera_m"),
            "camera_to_target_distance_m": det.get("camera_to_target_distance_m"),
            "camera_to_target_depth_m": det.get("camera_to_target_depth_m"),
